...
//From: https://github.com/Webstrates/Webstrates/blob/master/client/webstrates/coreMutation.js
...
coreMutationModule.emitMutationsFrom = (_rootElement) => {
...
let isPaused = true;
Object.defineProperty(coreMutationModule, 'isPaused', {
	get: () => isPaused
});


coreMutationModule.pause = () => {
	if (isPaused) return;
...
export const coreMutation = coreMutationModule;
