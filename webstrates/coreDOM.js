...
// From: https://github.com/Webstrates/Webstrates/blob/master/client/webstrates/coreDOM.js
...
coreDOMModule.setDocuments = function(document, _document, documentProxyObj) {
	coreDOMModule.internalDocument = document;
	coreDOMModule.externalDocument = _document;
...
export const coreDOM = coreDOMModule;
